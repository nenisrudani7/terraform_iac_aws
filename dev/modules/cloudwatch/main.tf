...
#           stat   = var.stat
#           region = var.region
#           title  = "${var.service_id}-${var.service_name}-${var.type_of_metrics.first_metrics}"
#         }
#       },
#       {
...
#             [
#               "AWS/${var.service_name}",
#               var.type_of_metrics.second_metrics, 
#                var.type_mantioned , 
#               "${var.service_id}"
#             ]
#           ]
...
#           stat   = var.stat
#           region = var.region 
#           title  = "${var.service_id} - ${var.type_of_metrics.second_metrics}"
#         }
#       }
#     ]
#   })
...
#   metric_name               = var.type_of_metrics.first_metrics 
      ...
      # CPU Utilization Widget
      {
        ...
        properties = {
          metrics = [
            [
              "AWS/${var.service_name}",
              var.type_of_metrics.first_metrics,
              var.type_mantioned,
              var.service_id
            ]
          ]
          ...
          stat   = var.stat
          region = var.region
          title  = "${var.service_id} - ${var.type_of_metrics.first_metrics}"
        }
      },
